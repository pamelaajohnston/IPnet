...
IMAGE_SIZE = ipNet_input.IMAGE_SIZE
NUM_CLASSES = ipNet_input.NUM_CLASSES
NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN = ipNet_input.NUM_EXAMPLES_PER_EPOCH_FOR_TRAIN
NUM_EXAMPLES_PER_EPOCH_FOR_EVAL = ipNet_input.NUM_EXAMPLES_PER_EPOCH_FOR_EVAL
...
def distorted_inputs():
  ...
  #images, labels = ipNet_input.distorted_inputs(data_dir=data_dir, batch_size=FLAGS.batch_size, distort=False)
  images, labels = ipNet_input.distorted_inputs(data_dir=data_dir, batch_size=FLAGS.batch_size, distort=1)
...
def inputs(eval_data):
  ...
  images, labels = ipNet_input.inputs(eval_data=eval_data,
                                        data_dir=data_dir,
...
def inference_switch(images, type=1):
    #if FLAGS.binarise_label > 0:
    #    NUM_CLASSES = 2
    #    ipNet_input.NUM_CLASSES = 2
    #elif FLAGS.binarise_label == -2:
    #    NUM_CLASSES = 4
    #    ipNet_input.NUM_CLASSES = 4
    #elif FLAGS.binarise_label == -3:
    #    NUM_CLASSES = 3
    #    ipNet_input.NUM_CLASSES = 3
